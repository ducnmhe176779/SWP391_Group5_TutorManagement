                        ...
                        <div class="widget-box">
                            ...
                            <div class="widget-inner">
                                <c:if test="${not empty sessionScope.error}">
                                    <div style="color: red;">
                                        <c:choose>
                                            <c:when test="${sessionScope.error == 'AddFailed'}">
                                                <fmt:message key="subject_add_failed"/>
                                            </c:when>
                                            <c:otherwise>
                                                ${sessionScope.error}
                                            </c:otherwise>
                                ...
                                <form action="${pageContext.request.contextPath}/admin/AdminSubjectController?service=addSubject" method="post">
