    ...
    <div class="page-wraper">
            ...
            <div class="account-form-inner">
                <div class="account-container">
                    <div class="heading-bx left">
                        <h2 class="title-head"><fmt:message key="reset"/> <span><fmt:message key="password"/></span></h2>
                    ...
                    <form class="contact-bx" action="resetPassword" method="POST">
                        <div class="row placeani">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    <div class="input-group">
                                        <label><fmt:message key="confirm_password"/></label>
                            ...
                            <div class="col-lg-12 m-b30">
                                <button type="submit" class="btn button-md"><fmt:message key="reset_password"/></button>
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                console.log('Trang resetPassword đã load xong');
